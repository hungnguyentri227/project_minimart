...
public class Login extends javax.swing.JFrame {
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        try {
            if (DAO.Validation_Login(username, password)) {
                ...
                if (dto != null) {
                    if (dto.getRole().equalsIgnoreCase("admin")) {
                        ...
                        JOptionPane.showMessageDialog(this, "Your role is not supported!", "Error!", 0);
                    }
                } else {
                    JOptionPane.showMessageDialog(this, "Invalid UserName or PassWord! Please try again!", "Error!", 0);
                }
            }
        } catch (Exception e) {
